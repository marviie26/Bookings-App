...
export default function PlacesScreen() {
  ...
  const data = [
    {
      ...
      placeImage:
      "https://images.nigeriapropertycentre.com/area-guides/bf04bb6c-13cd-4ed1-b7e9-4ef4e6b154ce.jpg",

      shortDescription: "City in Lagos, Nigeria",
      properties: [
        {
          id: "10",
          name: "Maison Fahrenheit",
          image:
            "https://lh3.googleusercontent.com/p/AF1QipNjkd9ogVsh6olmer2i1ig5xKPH_elLA641g1T8=w296-h202-n-k-rw-no-v1",
          rating: 4.2,
          address:
        ...
        },
        {
          id: "11",
          image:
            "https://www.thelagoscontinental.com/wp-content/uploads/2022/12/About-Lagos-Continental-768x752.png",
        ...
        {
          id: "12",
          name: " Radisson blu hotel VI",
          rating: 4.5,
          address:
            "1a Ozumba Mbadiwe Ave, Victoria Island, Lagos",
          oldPrice: 3800,
          newPrice: 3078,
          latitude: " 6.4250275",
          longitude: "3.420763",
          image:
            "https://media.radissonhotels.net/image/radisson-blu-anchorage-hotel-lagos-vi/exteriorview/16256-116549-f63887244_3xl.jpg?impolicy=CustomCrop&cwidth=800&cheight=610",
          photos: [
            {
              id: "120",
              image:
    ...
    },
    {
      ...
      place: "Ikeja",
      placeImage:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBYKe9ZIfnIsql7KWzih3sxXev9SaElyvY8zDClEEpQg&s",
      shortDescription: "City in Lagos, Nigeria",
      properties: [
        {
          id: "20",
          name: "Presken hotel and resort",
          rating: 4,
          address:
            "CFC-4/C, Road No-2 Hardware Park, Beside TCS, Tukkuguda, 501351 Hyderabad, India",
          oldPrice: 100000,
          newPrice: 69500,
          Latitude: 6.60858217282,
          Longitude: 3.35012365764,
          photos: [
            {
              id: "140",
              image:
        ...
        },
        {
          ...
          rating: 3.5,
          address:
            "5, Ishola Bello Cl, off Iyalla Street besides Ikeja City Mall, Alausa",
          oldPrice: 40000,
          newPrice: 36499,
          photos: [
            {
  ...
  return (
    ...
    <Pressable className=" flex-row items-center justify-between px-6  py-2 bg-white">
      <Pressable
        onPress={() => setModalVisibile(!modalVisibile)}
       className=" flex-row items-center"
      >
        <Octicons name="arrow-switch" size={22} color="gray" />
        <Text className="  text-xs font-medium  ml-2 p-1 ">
          Sort
        </Text>
      </Pressable>

      <Pressable   className=" mr-4 flex-row items-center px-2">
      ...
      footer={
        <ModalFooter>
          ...
          onPress={() => applyFilter(selectedFilter)}
           ...
           className=" pr-2 ml-auto mr-auto my-2 mb-6 hover:bg-green-300"
          >
            <Text>Apply</Text>
          </Pressable>
        </ModalFooter>
    ...
    >
        ...
        <View className=" flex-row">
          <View className=" my-3  mx-3  flex h-64 border-r border-slate-400">
            <Text className=" items-center py-2">Sort </Text>
          </View>
